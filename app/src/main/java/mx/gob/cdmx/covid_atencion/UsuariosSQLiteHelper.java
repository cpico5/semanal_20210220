...
/////////////////////  TABLA ENCUESTAS  ///////////////////////////////////////////////
    ...
    public static class TablaEncuestas{
        ...
        public static String COLUMNA_pregunta_c2a="pregunta_c2a";
        public static String COLUMNA_pregunta_c2b="pregunta_c2b";
        public static String COLUMNA_pregunta_c2c="pregunta_c2c";
        ...
        public static String COLUMNA_pregunta_c9d="pregunta_c9d";
        public static String COLUMNA_pregunta_c9e="pregunta_c9e";
        public static String COLUMNA_pregunta_c9f="pregunta_c9f";
        public static String COLUMNA_pregunta_c9g="pregunta_c9g";
        ...
        public static String COLUMNA_pregunta_c11b="pregunta_c11b";
        public static String COLUMNA_pregunta_c11c="pregunta_c11c";
        public static String COLUMNA_pregunta_c11d="pregunta_c11d";
    ...
    private static final String DATABASE_ENCUESTA= "create table "
            ...
            + TablaEncuestas.COLUMNA_pregunta_c2a +  " text, "
            + TablaEncuestas.COLUMNA_pregunta_c2b +  " text, "
            + TablaEncuestas.COLUMNA_pregunta_c2c +  " text, "
            ...
            + TablaEncuestas.COLUMNA_pregunta_c9d +  " text, "
            + TablaEncuestas.COLUMNA_pregunta_c9e +  " text, "
            + TablaEncuestas.COLUMNA_pregunta_c9f +  " text, "
            + TablaEncuestas.COLUMNA_pregunta_c9g +  " text, "
            ...
            + TablaEncuestas.COLUMNA_pregunta_c11b +  " text, "
            + TablaEncuestas.COLUMNA_pregunta_c11c +  " text, "
            + TablaEncuestas.COLUMNA_pregunta_c11d +  " text, "

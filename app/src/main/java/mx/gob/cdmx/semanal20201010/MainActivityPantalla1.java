...
import mx.gob.cdmx.semanal20201010.model.DatoContent;
import mx.gob.cdmx.semanal20201010.model.Usuario;

import static android.text.Layout.JUSTIFICATION_MODE_INTER_WORD;
import static mx.gob.cdmx.semanal20201010.Nombre.USUARIO;
import static mx.gob.cdmx.semanal20201010.Nombre.customURL;
import static mx.gob.cdmx.semanal20201010.Nombre.encuesta;
    ...
    rdPreguntac8b.setOnCheckedChangeListener(new OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(RadioGroup group, int checkedId) {
            if (checkedId == R.id.radio1) {
                ...
                opc8b = "Nunca votaría para que alguien se reeligiera";
            }
            else if (checkedId == R.id.radio0) {
    ...
    rdPreguntac9.setOnCheckedChangeListener(new OnCheckedChangeListener() {
        ...
        public void onCheckedChanged(RadioGroup group, int checkedId) {
            if (checkedId == R.id.radio1) {
                ...
                opc9 = "Marco Rascón/ PHCDMX";
                layc9a .setVisibility(View.GONE);	rdPreguntac9a.clearCheck();	opc9a="No aplica";
            }
            else if (checkedId == R.id.radio9) {
                opc9 = "Purificación Carpinteyro/ PANAL";
                layc9a .setVisibility(View.GONE);	rdPreguntac9a.clearCheck();	opc9a="No aplica";
            }
...
public void guardar(View v) {
    ...
    switch (tipo) {
        case 1:
            ...
            else if (layc5a.getVisibility() == View.VISIBLE && opc5a.matches("sin datos") && editPreguntac5a.getText().toString().trim().length() == 0 ){Toast.makeText(getBaseContext(),"CAPTURA:  " +  capturac5a,Toast.LENGTH_LONG).show();}

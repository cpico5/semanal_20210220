...
import mx.gob.cdmx.semanal_20201114.model.DatoContent;
import mx.gob.cdmx.semanal_20201114.model.Usuario;

import static android.text.Layout.JUSTIFICATION_MODE_INTER_WORD;
import static mx.gob.cdmx.semanal_20201114.Nombre.USUARIO;
import static mx.gob.cdmx.semanal_20201114.Nombre.customURL;
import static mx.gob.cdmx.semanal_20201114.Nombre.encuesta;
...
public String opc6a="sin datos";   public RadioGroup rdPreguntac6a;   public EditText editPreguntac6a;   public String capturac6a;  LinearLayout layc6a;

public String opc6b="sin datos";   public RadioGroup rdPreguntac6b;   public EditText editPreguntac6b;   public String capturac6b;  LinearLayout layc6b;

public String opc6c="sin datos";   public RadioGroup rdPreguntac6c;   public EditText editPreguntac6c;   public String capturac6c;  LinearLayout layc6c;

public String opc6d="sin datos";   public RadioGroup rdPreguntac6d;   public EditText editPreguntac6d;   public String capturac6d;  LinearLayout layc6d;

public String opc6e="sin datos";   public RadioGroup rdPreguntac6e;   public EditText editPreguntac6e;   public String capturac6e;  LinearLayout layc6e;
...
rdPreguntac6a = (RadioGroup)findViewById(R.id.rdPreguntac6a); captura1 =res.getString(R.string.PREGUNTAc6a);  layc6a = (LinearLayout) findViewById(R.id.layc6a);

rdPreguntac6b = (RadioGroup)findViewById(R.id.rdPreguntac6b); captura1 =res.getString(R.string.PREGUNTAc6b);  layc6b = (LinearLayout) findViewById(R.id.layc6b);

rdPreguntac6c = (RadioGroup)findViewById(R.id.rdPreguntac6c); captura1 =res.getString(R.string.PREGUNTAc6c);  layc6c = (LinearLayout) findViewById(R.id.layc6c);

rdPreguntac6d = (RadioGroup)findViewById(R.id.rdPreguntac6d); captura1 =res.getString(R.string.PREGUNTAc6d);  layc6d = (LinearLayout) findViewById(R.id.layc6d);

rdPreguntac6e = (RadioGroup)findViewById(R.id.rdPreguntac6e); captura1 =res.getString(R.string.PREGUNTAc6e);  layc6e = (LinearLayout) findViewById(R.id.layc6e);
...
rdPreguntac10a = (RadioGroup)findViewById(R.id.rdPreguntac10a); captura1 =res.getString(R.string.PREGUNTAc10a);  layc10a = (LinearLayout) findViewById(R.id.layc10a);

rdPreguntac10b = (RadioGroup)findViewById(R.id.rdPreguntac10b); captura1 =res.getString(R.string.PREGUNTAc10b);  layc10b = (LinearLayout) findViewById(R.id.layc10b);

rdPreguntac11 = (RadioGroup)findViewById(R.id.rdPreguntac11); captura1 =res.getString(R.string.PREGUNTAc11);  layc11 = (LinearLayout) findViewById(R.id.layc11);
...
opc1 = "Han aumentado mucho";
}

else if (checkedId == R.id.radio4) {
opc1 = "Han aumentado algo";
}
...
opc1 = "Han disminuido algo";
}

else if (checkedId == R.id.radio7) {
opc1 = "Han disminuido Mucho";
}
...
opc4 = "Piensa comprar algo pero todavía no lo hace";
  ...
  layc5d .setVisibility(View.VISIBLE);	rdPreguntac5d.clearCheck();	opc5d="sin datos";
  layc5e .setVisibility(View.VISIBLE);	rdPreguntac5e.clearCheck();	opc5e="sin datos";
  ...
  layc6d .setVisibility(View.VISIBLE);	rdPreguntac6d.clearCheck();	opc6d="sin datos";
  layc6e .setVisibility(View.VISIBLE);	rdPreguntac6e.clearCheck();	opc6e="sin datos";

}

else if (checkedId == R.id.radio4) {
opc4 = "Ya aprovecho y compro";
  ...
  layc5d .setVisibility(View.GONE);	rdPreguntac5d.clearCheck();	opc5d="No aplica";
  layc5e .setVisibility(View.GONE);	rdPreguntac5e.clearCheck();	opc5e="No aplica";
  layc6 .setVisibility(View.VISIBLE);	rdPreguntac6.clearCheck();	opc6="sin datos";
  layc6a .setVisibility(View.VISIBLE);	rdPreguntac6a.clearCheck();	opc6a="sin datos";
  layc6b .setVisibility(View.VISIBLE);	rdPreguntac6b.clearCheck();	opc6b="sin datos";
  layc6c .setVisibility(View.VISIBLE);	rdPreguntac6c.clearCheck();	opc6c="sin datos";
...
opc4 = "No piensa comprar nada";
  ...
  layc6d .setVisibility(View.GONE);	rdPreguntac6d.clearCheck();	opc6d="No aplica";
  layc6e .setVisibility(View.GONE);	rdPreguntac6e.clearCheck();	opc6e="No aplica";
...
opc9b = "Nunca votaría para que alguien se reeligiera";
}
